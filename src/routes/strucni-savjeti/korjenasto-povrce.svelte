<svelte:head>
    <title>Agrimatco | Stručni savjeti | Korjenasto povrće</title>
</svelte:head>

<section class="section">
    <div class="container">
        <nav><small><a rel="prefetch" href="strucni-savjeti">Stručni savjeti</a> > Korjenasto povrće</small></nav>
        <h1>Prihrana korijenastog povrća</h1>

        <p>Mrkva, peršin, celer, pastrnjak i cikla, spadaju u skupinu povrća kojemu za rast i razvoj pogoduju umjereno topla i vlažna područja. Sjeme klija pri relativno niskim temperaturama, već na 3 do 4 °C, a samo cikla na 6 do 8 °C. Mlade biljčice relativno su otporne na kasne proljetne mrazeve, što omogućuje sjetvu korjenastog povrća relativno rano u proljeće. Isto tako i rani jesenski mrazevi ne nanose im značajnije štete.</p>
        <p><img src="strucni-savjeti/korijenasto-povrce/i1.jpg" alt=""></p>
        ...
        <p><img src="strucni-savjeti/korijenasto-povrce/i3.jpg" alt=""></p>
        ...
        <p>Za jačanje biljnih funkcija/antistres koristiti  Bioplex 0,3 – 0,5 L/ha svakih 7-10 dana. Bioplex je biostimulator koji se primjenjuje kod visokih temperatura i nepovoljnih uvjeta.</p>
        <p><img src="strucni-savjeti/korijenasto-povrce/i2.jpg" alt=""></p>
        ...
        <hr>
        <h2>Fenofaze</h2>
        <p><img src="strucni-savjeti/korijenasto-povrce/i-fen.jpg" alt=""></p>

        <hr>
        <h2>Nedostatci</h2>
        <p><img src="strucni-savjeti/korijenasto-povrce/i-ned.jpg" alt=""></p>
    </div>
</section>
