  ...
  let groups = [
    {
      ...
      items: [
        ...
        },
        {
          title: 'Trazex',
          description:
            'Visoka koncentracija mikroelemenata u fazama rasta i cvjetanja za folijarnu primjenu',
        ...
        },
        {
          title: 'Tropicel',
          description:
            'Vodotopivo folijarno gnojivo s visokom koncentracijom bora, cinka i molibdena',
        ...
        },
        {
          title: 'Kelatex Zn',
          description:
            'Vodotopivo gnojivo za folijarnu primjenu s visokom koncentracijom cinka (Zn)',
        ...
        },
        {
          title: 'Kelatex Fe',
          description:
            'Vodotopivo gnojivo za folijarnu primjenu s visokom koncentracijom željeza (Fe)',
...
<svelte:head>
  <title>Agrimatco | Proizvodi | Suha topiva gnojiva</title>
</svelte:head>

<section class="section">
  <div class="container">
    <nav><small><a href="/proizvodi">Proizvodi</a> > Suha topiva gnojiva</small></nav>
    <h1>Suha topiva gnojiva</h1>
