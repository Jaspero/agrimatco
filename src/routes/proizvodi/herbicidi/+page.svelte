      ...
      items: [
        {
          ...
          link: 'katalozi/2023-gnojidba-prihrana-zastita.pdf#page=60'
        },
        {
          title: 'Cash',
        ...
        },
        {
          ...
          description:
            'Totalni herbicid za suzbijanje travnih i širokolisnih korova. Glifosat 360 g/L',
          image: 'herbicidi/gallup-super-480.png',
          link: 'katalozi/2023-gnojidba-prihrana-zastita.pdf#page=61'
        },
        {
          title: 'Plaza WG',
...
<svelte:head>
  <title>Agrimatco | Proizvodi | Herbicidi</title>
</svelte:head>

<section class="section">
  <div class="container">
    <nav><small><a href="/proizvodi">Proizvodi</a> > Herbicidi</small></nav>
    <h1>Herbicidi</h1>
