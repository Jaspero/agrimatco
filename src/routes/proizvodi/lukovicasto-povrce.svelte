<svelte:head>
    <title>Agrimatco | Proizvodi | Lukovičasto povrće</title>
</svelte:head>
...
<section class="section">
    <div class="container">
        <nav><small><a rel="prefetch" href="proizvodi">Proizvodi</a> > Lukovičasto povrće</small></nav>
        <h1>Lukovičasto povrće</h1>
