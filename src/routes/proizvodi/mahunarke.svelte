<svelte:head>
    <title>Agrimatco | Proizvodi | Mahunarke</title>
</svelte:head>
    ...
    let groups = [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    image: 'sjeme-povrca/mahunarke/mahune/fiorino.png',
                    link: 'katalozi/2022-sjeme-povrca.pdf#page=59'
                },
                {
                    title: 'Radovan',
                    description: 'Dobavljač: SAIS',
                    image: 'sjeme-povrca/mahunarke/mahune/radovan.png',
                    link: 'katalozi/2022-sjeme-povrca.pdf#page=59'
                },
            ]
        }
...
<section class="section">
    <div class="container">
        <nav><small><a rel="prefetch" href="proizvodi">Proizvodi</a> > Mahunarke</small></nav>
        <h1>Mahunarke</h1>
